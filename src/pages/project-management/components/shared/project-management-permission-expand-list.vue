<template>
  <div
    class="project-management-permission-expand-list rounded-borders overflow-hidden column justify-start items-stretch"
  >
    <q-expansion-item
      :label="module.title"
    ...
    >
      ...
      <q-card class="column">
        <q-card-section
          class="column justify-start items-stretch q-py-none bg-grey-1"
        >
