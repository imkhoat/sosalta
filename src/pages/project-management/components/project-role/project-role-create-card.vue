<template>
  <q-card class="project-management-new-role-card">
    <q-form
    ...
    >
      ...
      <q-card-section>
        <q-input
          ...
          v-model="roleName"
        ></q-input>
        <div class="project-management-new-role-card__role">
          <q-skeleton-suspense>
...
const menus = ref<Map<ProjectPermissionCodeType, UserMenu[]>>(new Map())
