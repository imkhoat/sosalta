              ...
              >
                <div class="row justify-center items-center no-wrap">
                  <q-icon
                    ...
                    :class="{
                      'text-primary': !checkingActiveSort(item, 1),
                      'text-grey-4': checkingActiveSort(item, 1),
                    }"
                  ></q-icon>
                  <q-icon
                    size="xs"
                    ...
                    :class="{
                      'text-primary': checkingActiveSort(item, 2),
                      'text-grey-4': !checkingActiveSort(item, 2),
                    }"
                  ></q-icon>
                </div>
              </q-avatar>
...
function checkingActiveSort(item: SortOption, direction: number) {
  return (
    direction === activeSortDirection.value &&
    item.sortType === activeSortType.value
  )
}
