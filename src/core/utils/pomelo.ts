...
const defaultDecode = (pomelo.decode = function (data) {
  //probuff decode
...
const defaultEncode = (pomelo.encode = function (reqId, route, msg) {
...
const connect = function (param, url, cb) {
...
const processMessage = function (pomelo, msg) {
  if (!msg.id) {
    // server push message
